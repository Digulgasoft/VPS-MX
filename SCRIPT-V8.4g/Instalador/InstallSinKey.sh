...
install_paketes() {
  ...
  msg -bar
  echo -e "\033[97m"
  echo -e "  \033[41m    -- INSTALAÇÃO DE PACOTES PARA VPS-MX --    \e[49m"
  echo -e "\033[97m"
  msg -bar
  #grep
...
cd /etc/VPS-MX
wget https://raw.githubusercontent.com/Digulgasoft/VPSMX/master/SCRIPT-V8.4g/Files/VPS-MX.tar.xz >/dev/null 2>&1
...
wget https://github.com/lacasitamx/VPSMX/raw/master/SCRIPT-V8.4g/Fix/HELP -O /usr/bin/HELP &>/dev/null &>/dev/null
chmod 775 /usr/bin/HELP &>/dev/null
wget https://github.com/lacasitamx/VPSMX/raw/master/SCRIPT-V8.4g/Fix/SPR -O /usr/bin/SPR &>/dev/null &>/dev/null
chmod 775 /usr/bin/SPR &>/dev/null
wget -O /usr/bin/SOPORTE https://github.com/lacasitamx/VPSMX/raw/master/SCRIPT-V8.4g/Fix/SOPORTE.sh &>/dev/null
chmod 775 /usr/bin/SOPORTE &>/dev/null
SOPORTE &>/dev/null
wget -O /bin/rebootnb https://raw.githubusercontent.com/Digulgasoft/VPSMX/master/SCRIPT-8.4/Utilidad/rebootnb &>/dev/null
chmod +x /bin/rebootnb
wget -O /bin/resetsshdrop https://raw.githubusercontent.com/Digulgasoft/VPSMX/master/SCRIPT-8.4/Utilidad/resetsshdrop &>/dev/null
